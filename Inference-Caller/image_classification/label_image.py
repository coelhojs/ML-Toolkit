...
from utils.label_util import load_labels
...
def image_classifier(images_list, model_path, labels_path, input_layer = "Placeholder", output_layer = "final_result"):
  input_height = 299
  input_width = 299
  input_mean = 0
  input_std = 255
...
if __name__ == "__main__":
  ...
  if (input_layer and output_layer):
    image_classifier(images_list, model_file, label_file, input_layer, output_layer)
  else:
    image_classifier(images_list, model_file, label_file)